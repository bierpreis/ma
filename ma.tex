...
Eine sehr wichtige Methode ist \textit{isCosnsitentWith(PConditional c)}. Hiermit wird geprüft, ob die vorhandene Wissensbasis konsistent mit dem übergebenem Konditional ist. Die Implementierung der Methode ist in \autoref{code:kb-consistent} zu sehen.
