...
\subsection{Äquivalenz und eine Ordnungsrelation für Konditionale}
Äquivalenz für Konditionale soll im weiteren Verlauf dadurch definiert sein, dass zwei äquivalente Konditionale die Menge der möglichen Welten auf die gleiche Art und Weise unterteilen:\\
todo: wofür eigentlich die äquivalenz??
\begin{equation}
(B|A)\equiv (B^\prime|A^\prime) \quad iff \quad A\equiv A^\prime \quad and \quad AB \equiv A^\prime B^\prime
\end{equation}
Im Folgenden wird eine Ordnungsrelation für Konditionale definiert, unter der sie später bearbeitet und gespeichert werden können. Mit $\leq_{lex}$ wird eine Ordnungsrelation für Zeichen und mit  $\leq_{set}$ eine Ordnungsrelation für Mengen bezeichnet.
