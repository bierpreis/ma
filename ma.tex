...
Um den Wahrheitsgehalt eines Konditionals zu bestimmen, werden sie oft im Rahmen von ordinalen Rangfunktionwn nach Wolfgang Spohn betrachtet, wie beispielsweise in \cite{spohn88} oder \cite{spohn12} beschrieben. Mehr dazu auch in diesem Text im Abschnitt zu  \hyperref[sec:Wissensbasen]{Wissensbasen}. Ein unsicheres Konditional wird dann als wahr akzeptiert, wenn es plausibler ist als das dazu umgekehrte Konditional. Beispielsweise $(B|A)$ wird dann akzeptiert, wenn $A \and B$ plausibler ist als $A \and \overline{B}$, siehe dazu auch \cite{isberner14}. \\
