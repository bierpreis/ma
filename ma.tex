...
todo: neuer speed test mit kb writer und hdd buffer? \\
kurzer test hat ergeben: 280s ohne translator, 250/251 mit translator. verwenden? translator verbessern? beschreiben! \\
todo:Performance Vergleich mit kurzen Übersetzungen als Begründung warum die nicht verwendet werden.
\\todo: conjunktive normalform? das ist die einfache translation. siehe dazu auch \cite{beierle19b} s. 40 dazu. das ist ok so?
\subsection{Wissensbasen}
...
todo: neuer screen gesamt. auch an options die nummer kb option erklären
