...
%this fixes problem with text cannot be marked! duno why
\usepackage{lmodern} 
...
\usepackage[twoside,top=1.8cm,bottom=1.8cm]{geometry}
...
\begin{figure}
\includegraphics[width=0.85\linewidth]{bilder/overview.png}
