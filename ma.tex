...
\begin{abstract}\noindent
In dieser Arbeit wird ein Algorithmus zum Erstellen von Wissensbasen über einer vorgegebenen Signatur experimentell implementiert. Dazu wird ein Java Programm erstellt, welches den Algorithmus umsetzt und dessen Ergebnisse persistent speichert.
\end{abstract}
