...
In den folgenden Unterabschnitten wird der Weg beschrieben, wie die Konditionale in Normalform berechnet werden. Dazu wird gezeigt, wie Mengen möglicher Welten dargestellt werden, wie damit Konditionale dargestellt werden und anschließend, wie die damit als Basis die Menge der Konditionale berechnet wird.
