...
Die Klasse \textit{AbstractPairBuffer} ist die abstrakte Klasse, welche von beiden Varianten der Speicherverwaltung implementiert wird und hat hauptsächlich den Charakter eine Schnittstelle. Da sich die Implementierungen stark unterscheiden, stellt diese abstrakte Klasse kaum eigene Funktionalität bereit und enthält dafür diverse abstrakte Methoden. Das sind zum Einen Methoden um die Iterationen zu verwalten und zum Anderen um der grafischen Oberfläche Informationen bereit zu stellen. \\
