...
Mit qualitativen Konditionalen in der Form \glqq Wenn A, dann normalerweise B\grqq  \space ist es möglich Wissen unter Unsicherheit repräsentiert werden. Eine  Menge solcher Konditionale kann zu einer Wissensbasis zusammengefasst werden. Die Programmbilbiothek InfOCF (siehe dazu \cite{kutsch20})  bietet verschiedene Funktionen zur Arbeit mit Konditionalen und Wissensbasen. Um dieses System experimentell zu evaluieren werden größere Mengen von Wissensbasen benötigt. \textit{GenKB} (siehe \cite{beierle19}) ist ein Algorithmus um Wissensbasen systematisch zu generieren. Das Ziel dieser Arbeit ist es, diesen Algorithmus in ein Programm zum implementieren.\\
