...
Um die Akzeptanz eines unsicheren Konditionals zu bestimmen, werden sie oft im Rahmen von ordinalen Rangfunktionen nach Wolfgang Spohn betrachtet, wie beispielsweise in \cite{spohn88} oder \cite{spohn12} beschrieben. Mehr dazu auch in diesem Text im Abschnitt zu  \hyperref[sec:Wissensbasen]{Wissensbasen}. Grundsätzlich wird ein unsicheres Konditional dann als akzeptiert, wenn es plausibler ist als das gegenteilige Konditional. Beispielsweise $(B|A)$ wird  dann akzeptiert, wenn $A \wedge B$ plausibler ist als $A \wedge \overline{B}$, siehe dazu auch \cite{isberner14}. \\
