...
Die Klassen \textit{World} und \textit{Signature} hängen eng zusammen. Die Bais bildet die Klasse \textit{AbstractWorld}, wobei diese Klasse für sich keine Funktion bietet und einfach eine Schnittstellt darstellt. Implementiert wird die Klasse AbstractWorld von den Konkreten Klassen \textit{ABWorld} und ABC textit{World.}
