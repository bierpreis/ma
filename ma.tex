...
Nicht zu verwechseln mit der \textit{equals(..)} Methode ist die Methode \textit{isEquivalent(WConditional other)}. Sie gibt genau dann true zurück, wenn das übergebene WConditional äquivalent zu einem WConditonal ist. Sie funktioniert so, dass überprüft wird, ob ein im Sinne von \textit{equals(..)} gleiches WConditional in der Liste der äquivalenten Konditionale vorhanden ist.
