...
Die Grafische Oberfläche des KBCreators ist in \autoref{pic:kbcreator_gesamt} gezeigt und besteht aus zwei Teilen: Die linke Seite beinhaltet die möglichen Optionen, die zum generieren der Wissensbasis eingestellt werden können. Einige Optionen sind dabei von Anderen abhängig und werde ausgegraut dargestellt, wenn sie in der aktuell gewählten Optionen nicht sinnvoll zu bearbeiten sind. Am unteren Ende der Einstellungen befinden sich der Start und der Stop Button für den Creator. \\
