...
Um zu prüfen, ob ein Objekt der Klasse WContitional äquivalent zu einem Anderen ist, besitze die Klasse die Methode \textit{isEquivalent(WConditonal otherConditional)}.
\\todo: beschreiben der buttons (nfc vs conditionals - unterschied ist sortierung)
\label{equivalence}
