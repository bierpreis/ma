...
Die Aufgabenstellung wird zunächst in zwei Teile gegliedert. Im ersten Teil werden basierend auf der Signatur $\Sigma=\{a,b,c\}$  die Konditionale in Normalform berechnet und somit die Menge aller Konditionale $NFC$  berechnet. Anschließend werden die Äquivalenzklassen Untersucht und damit die Menge $cNFC$ sowie die einzelnen Äquivalenzklassen berechnet. Dabei werden die Konditional auch nach der Ordnunggsrelation $\rdotl$ sortiert.\\
