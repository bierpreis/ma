...
Als Input dafür wird die Liste an WorldsLists aus \autoref{possible-worlds} mit ihren 255 Elementen verwendet. Der Algorithmus dazu ist in \autoref{create-conditionals} zu sehen.
 \\todo:algo beschreiben. Der Output der Methode ist eine Liste aller möglichen Konditionale in Normalform basierend auf der Liste der WorldsLists.
\begin{figure}
\begin{lstlisting}
