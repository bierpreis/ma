...
Falls alle Konditionale der Wissensbasis die Welt tolerieren, ist die boolean Variable \textit{toleratesAll} in Zeile 8 true und in Zeile 9 wird true zurückgegeben. Wenn mindestens ein Konditional die Welt nicht toleriert, wird in Zeile 1 weiter über alle Welten iteriert. Wenn die Konsistenz für keine mögliche Welt gefunden wird, gibt der Algorithmus in Zeile 12 false zurück. \\
