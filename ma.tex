...
todo \\
In diesem Abschnitt soll kurz die Betrachtung des Erstellten Programms mit dem Profiler JVisualVM gezeigt werden. JVisualVM ist ein Java Profiler, mit dem Java Programme während der Laufzeit näher betrachtet werden, nähre Informationen dazu gibt es auf der Seite von Oracle, \cite{jvis20}.
