...
Die beiden Queues werden von der Impementierung von GenKB wie folgt verwendet: Die lastIterationQueue stellt die Pairs aus Iteration $k$ bereit, damit GenKB sie nacheinander entnehmen und bearbeiten kann. Das entspricht der Zeile 8 im Algorithmus. Die nextIterationqueue nimmt die neu erstellten Paare in GenKB auf, das entspricht dem Schritt in Zeile 12. Die Implementierung von GenKB greift dann also nicht auf den PairBuffer selbst zu, sondern beide Teilen sich die Queue und tauschen die Daten darüber aus.
