...
Falls alle Konditionale der Wissensbasis die Welt tolerieren, ist die boolean Variable \textit{toleratesAll} in Zeile 10 true und in Zeile 11 wird true zurückgegeben. Sobald ein Konditional die Welt nicht toleriert ist \textit{toleratesAll}false und es greift break in Zeile 7.Dann wird in Zeile 1 weiter über alle noch verbleibenden Welten iteriert. Wenn die Konsistenz für keine mögliche Welt gefunden wird, gibt der Algorithmus in Zeile 14 false zurück. \\
