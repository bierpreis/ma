...
In diesem Abschnitt soll kurz die Betrachtung des Erstellten Programms mit dem Profiler JVisualVM gezeigt werden. JVisualVM ist ein Java Profiler, mit dem Java Programme während der Laufzeit näher betrachtet werden, nähre Informationen dazu gibt es auf der Seite von Oracle, \cite{jvis20}. Hier lassen sich insbesondere Informationen zum Speicherverbrauch und zur CPU Nutzung finden. Es lassen sich weiterhin Informationen zu laufenden Threads und zur Rechenzeit einzelner Methoden untersuchen. \\
todo speicher\\
todo methoden \\
Die Betrachtung des Threadings mit dem Profiler bestätigt naheliegende Erwartungen. Über die verschiedenen Iterationen werden diverse Threads neu gestarted und auch wieder korrekt beendet. Ansonsten sind keine Auffälligkeiten zu beobachten.
