...
\end{figure} 
Zur Prüfung er Äquivalenz bietet die Klasse eine boolean Methode isEquivalent(WConditional otherConditional). Da das Vorgehen dazu recht umfangreich ist, ist es gesondert unter \ref{sec:equivalence} beschrieben.
