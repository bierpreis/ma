...
Mit qualitativen Konditionalen in der Form \glqq Wenn A, dann normalerweise B\grqq  \space kann Wissen unter Unsicherheit repräsentiert werden. Eine  Menge solcher Konditionale kann zu einer Wissensbasis zusammengefasst werden. Die Programmbilbiothek InfOCF (siehe dazu \cite{kutsch20})  bietet verschiedene Funktionen zur Arbeit mit Konditionalen und Wissensbasen. Um dieses System experimentell zu evaluieren werden größere Mengen von Wissensbasen benötigt.
 
Die als Ergebnis entstandenen Wissensbasen sollen dann dazu dienen, das System InfOCF (siehe \cite{beierle17}) experimentell zu evaluieren. \\
