...
todo: hier java version und KEINE benötigten biblioteken außer standard reinschreiben.t st
...
\subsection{Wissensbasen}
todo: add toNumbersFilestring and toStandardFileString (in diagram und in beschreibung nächstes todo)
\begin{figure}
...
todo: hier neue toString beschreiben \\
