...
Der HDDPairBuffer besitzt zwei Threads: Ein Thread, um die von GenKB übergebenen Paare auf der Festplatte zu speichern und ein Thread, um die Paare von der Festplatte zu lesen und GenKB bereit zu stellen. Dadurch, dass der Festplattenzugriff auf diese zwei Threads aufgeteilt wird wird vermieden, dass sich die Aufgaben gegenseitig behindern oder ausbremsen. Die Hauptklasse HDDPairBuffer bietet GenKB Methoden an, um ein Paar abzulegen und ein neues Paar abzurufen. Dabei leitet HDDPairBuffer diese Anfragen direkt an die beiden Threads zum Speichern und Abrufen der Daten weiter und tut selbst nichts damit. Neben diesen beiden Methoden zur Verabeitung der Pairs besitzt auch HDDPairBuffer Methoden zum Starten und Beenden von Iterationen und um der GUI Informationen bereit zu stellen. \\
hier: writerThread \\
hier: readerThread \\
\\todo: auch clear
\\todo: getnextPair
\\todo: add pair ->auch bedenken wegen parallel. ein punkt bleibt offen!
