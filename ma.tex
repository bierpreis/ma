...
Das ließe sich durch Multi Threading lösen. Ein Ansatz für GenKB mit Multi Threading wurde während der Entwicklung des beschriebenen Programms entwickelt. Das parallele erzeugen der Wissensbasen hat auch funktioniert, gescheitert ist es jedoch am Speichern der Ergebnisse in der richtigen Reihenfolge wie sie der ursprüngliche Algorithmus vorgibt. Mit einem von vornherein auf Multi Threading ausgerichteten Design sollte es aber möglich sein, mehrere Prozessorkerne für den Hauptalgorithmus zu nutzen und die Geschwindigkeit dadurch zu steigern. Mit dem hier vorliegenden Design wäre dies aber nur mit großem Aufwand möglich umzusetzen.
\\todo: max wert integer? ca m mrd. bei 20k/sec wissensbasen ist das nach 27h erreicht!!! namen auf long umstellen?!
