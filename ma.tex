...
Das Programm ist sehr leicht zu benutzen, es bringt für alle Funktionen eine GUI mit. Zum staten führt man einfach die Datei \glqq Conditionals.jar \grqq \space aus. Wenn man dafür die grafische Oberfläche des benutzten PCs verwendet, bekommt das Programm dann einen vom Arbeitsspeicher des PCs abhängigen maximal verwendbaren Arbeitsspeicher zugewiesen. Je nachdem, ob mit dem Programm sehr speicherintensive Aktionen ausgeführt werden sollen, kann das ausreichen oder auch nicht. Es ist auch möglich, Java Programmen eine benutzerdefinierte maximale Menge an Arbeitsspeicher zuzuweisen. Dazu startet man die Conditionals.jar .jar mit folgendem Konsolenbefehl: 
...
Wenn das Programm gestartet wurde, öffnet sich ein kleines Fenster. Hier kann der Benutzer dann  auswählen, ob er Konditionale betrachten oder Wissensbasen generieren will.
...
todo: schreiben, was folgt=!. also überleitung vom aufbau.
