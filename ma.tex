...
\end{figure} \\
todo: prüfung äquivalenz, wenn fertig. siehe dazu auch abschnitt zu äquivalenz\\
...
\label{wconditional}
\end{figure}
Die Klasse WConditional bildet die Basis für die Berechnung der Konditionale aus einer vorgegebenen Signatur. Der Fokus der Klasse liegt dabei auf der Generierung, Ordnung und Betrachtung der Äquivalenz der Konditionale. Ein vereinfachtes Diagramm der Klasse ist in \autoref{wconditional} zu sehen. Attribute der Klasse sind zum einen die Nummer des Konditionals gemäß der Ordnung $\rdotl$ gemäß Definition \ref{sortierung}. \\
todo: erklärung der ordnung verlinken \\ CounterConditional und die Liste von äquivalenten Konditionalen und die beiden WorldsLists Antecedent und Consequence. \\
