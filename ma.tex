...
\end{theorem}
Aus dieser Definition entsteht dann der folgende Algorithmus zum Testen einer Wissensbasis auf Konsistenz, ebenfalls entnommen aus \cite{goldszmidt96}. Der Input für den Algorithmus ist eine Wissensbasis $\mathcal{R}$.  Der Output ist die geordnete Partition, wenn sie konsistent ist, oder andernfalls nichts.\\
...
\paragraph{AbstractWorld und mögliche Welten} \mbox{}
