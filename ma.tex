...
!!!todo: erklärung was das mit den klammern soll?? \\
...
\begin{equation}
(B|A) \overset{\mathrm{c}}{\dotll} (B',A') \ iff \ \Omega_A \overset{\mathrm{\omega}}{\dotll} \Omega_{A'} oder \Omega_A =  \Omega_{A'} und \Omega_B \overset{\mathrm{\omega}}{\dotll} \Omega_{B'}
\end{equation}
