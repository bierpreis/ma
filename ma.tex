...
Die Klasse WConditional bildet die Basis für dasGgenerieren der Konditionale aus einer vorgegebenen Signatur. Der Fokus der Klasse liegt dabei auf der Generierung, Ordnung und Betrachtung der Äquivalenz der Konditionale. Ein vereinfachtes Diagramm der Klasse ist in \autoref{wconditional} zu sehen. Attribute der Klasse sind Nummer, CounterConditional und die Liste von äquivalenten Konditionalen. Antecedent und Consequence sind als Objekt der Klasse WorldsList implementiert. Diese Klasse ist gleich daneben in \autoref{wconditional} abgebildet. Sie ist im Prinzip eine Liste mit Nummern möglicher Welten, erweitert um je einer Methode zum Test von Äquivalenz und zur Sortierung.
