...
\end{equation}
\end{theorem}
Mit der Signatur $\sum = \{ a, b, c\}$ haben wir die Ordnungsrelation $a \dotl b \dotl c$. Daraus ergibt sich dann als Ordnung  der Mengen $\{a\} \dotll_{set} \{b\} \dotll_{set} \{c\} \dotll_{set} \{a,b\} \dotll_{set} \{a,c\} \dotll_{set}\{b,c\} \dotll_{set} \{a, b, c\}$
