...
In \autoref{code:genkb-gesamt} und \autoref{code:genkb-init} ist die Impelementierung von GenKb dargestellt. Der Algorithmus ist auf zwei Methoden verteilt damit keine einzelne übermäßig lange Methode erstellt. Die Aufteilung ist wie folgt: Der Eigentliche Algorithmus ist in \autoref{code:genkb-gesamt}, dieser ruft dann für Zeile 3-5 des Orginals die andere Methode zum initialisieren der Wissensbasen mit  jeweils einem Element auf. \\
