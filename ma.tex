...
Durch Umbenennung von Variablen ist es möglich, neue Kombinationen von Welten, Konditionalen und Wissensbasen zu schaffen, die sich außer der Umbenennung nicht von den Vorhandenen unterscheiden. Dieses Verhalten wird als Isomorphismus beschrieben. Die Menge an durch diesen Isomorphismus entstandenen Dingen, die sich außer die Umbenennung nicht unterscheiden, wird dann als Äquivalenzklasse bezeichnet. Beispielsweise enthält die Signatur $\Sigma_{abc}$ die mögliche Welt $\overline{a}bc$. Wenn jetzt $a$ in $b$ und $b$ in $a$ umbenannt wird, entsteht der Isomorphismus $a\overline{b}c$. Analog kann durch Umbenennung daraus $ab\overline{c}$ entstehen. Alle drei dieser möglichen Welten bilden zusammen eine Äquivalenzklasse. \\
!! todo:: isomorphismen und äquivalenzklassen. aber wie funktioniert das??
