...
\kappa((B|A))=\begin{cases}
            ...
            \end{cases}
\]
Eine Aussage oder ein Konditional $(B|A)$ wird in diesem System akzeptiert, wenn es plausibler ist und damit einen geringeren Rang besitzt, als dessen Negation, z.B. $\kappa(AB)<\kappa(A\overline{B})$. \\
