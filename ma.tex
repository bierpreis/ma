...
\section{GUI zum Erstellen und betrachten der Kodnitionale}
...
\label{pic:nfcviewer}
\end{figure}
Um die Ergebnisse des im Abschnitt zuvor gezeigten betrachten zu können, existiert eine einfache GUI namens NfcViewer. Ein Screenshot des Programms in in \autoref{pic:nfcviewer} zu sehen.
todo: beschreiben, screenshots. subsections? 
