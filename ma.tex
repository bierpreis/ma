...
Die Klasse RealPair speichert die Liste der Kandidaten zur Erweiterung der enthaltenen Wissensbasis als List<PConditional>. Das ist naheliegend und schnell, benötigt jedoch schnell sehr viel Speicher. Deshalb wird die Klasse RealPair nur in Verbindung damit genutzt,die Daten auf der Festplatte und nicht im Arbeitsspeicher zu behalten. Dadurch existieren zu jedem Zeitpunkt nur recht wenige Objekte dieser Klasse. Der Speicherbedarf ist dann unproblematisch und die hohe Verarbeitungsgeschwindigkeit kann genutzt weden.
