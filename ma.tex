...
Das beschriebene Programm zum generieren von Wissensbasen erfordert Java in der Version 1.8 oder höher. Es werden neben den in Java standardmäßig enthaltenen Bibliotheken keine Abhängigkeiten benötigt.
...
Alle Abbildungen in diesem Dokument sind eigene Darstellungen. Die Klassendiagramme wurden mit der Sofware \glqq Dia\grqq \space erstellt.
\bibliography{lit} 
\end{document}