...
Rangfunktionen wurden von Wolfgang Spohn entwickelt, siehe dazu auch \cite{spohn88}. \\
!!!todo: quelle richtig machen\\ Eine Rangfunktion ist eine Funktion in der Form $\kappa :  \Omega \rightarrow \mathbb{N}_0 $. Mit einer Rangfuntion wird einer Welt $\kappa$ aus den möglichen Welten $\Omega$ eine natürliche Zahl zugeordnet, um deren Grad an Plausibilität zu beschreiben. Die normalste aller Welten bekommt den Wert 0 zugewiesen, weniger plausiblere Welten bekommen aufsteigend entsprechend ihrer Unplausibilität höhere Werte zugeordnet. Mittels solcher Rangfunktionen können sowohl Aussagen als auch Konditionale betrachtet werden.\\
