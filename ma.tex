...
\begin{abstract}
In dieser Arbeit wird ein Algorithmus zum Erstellen von Wissensbasen über einer vorgegebenen Signatur experimentell evaluiert. Dazu wird ein Java Programm erstellt, welches den Algorithmus implementiert und dessen Ergebnisse persistent speichert.
\end{abstract}
