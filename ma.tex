...
\label{nfc-viewer}
\end{figure}
Dieses Programm und die dahinterliegende Logik wird in diesem Abschnitt in den folgenden teilen vorgestellt. Das Programm an sich ist nach dem Model-View-Controller Schema aufgebaut. Die Beschreibung hier im Text fokussiert sich dabei auf das fachliche Modell dahinter und an einigen Stellen auf die Bedienung und Präsentation der grafischen Oberfläche. Die Logik der GUI und des Controllers werde nicht beschrieben, da sie für das fachliche Thema uninteressant sind. \\
