...
Der KnowledgeBaseWriter kümmert sich um die Aufnahme der Wissensbasen, die von GenKB erstellt werden. Das beinhaltet zum einen die konsistenten, aber auch die Inkonsistenten Wissensbasen. Es sind zwei Vairanten implementiert, zwischen denen der Benutzer wählen kann: Zum Einen können die Wissensbasen getrennt in konsistent und inkonsistent jeweils gruppiert nach Anzahl der enthaltenen Konditionale gespeichert werden, das übernimmt die Implementierung \textit{KbFileWriter}. Zum Anderen können die Wissensbasen direkt wieder gelöscht werden, das wird von der Impelementierung \textit{DummyWriter} übernommen. Das ist nützlich für Testläufe, denn es beschleunigt den gesamten Prozess und erspart das nachträgliche Löschen der Daten.
